...
const translations = {
    en: {
        ...
        header_p_2: 'Find and grab list of games from any steam public profile by just putting the steamID in the search, And after logged in you can easily see your friends list with there own games',
        ...
        directions_4: "If you've never set a custom Steam Community URL for your account, your 64 bit ID will be shown in the URL under the CUSTOM URL box in the format 76561198#########",
        directions_5: "If you have set a custom URL for your account, you can delete the text in the CUSTOM URL box to see your account's 64 bit ID in the URL listed below.",
        example: 'Example: 76561198866821009',
        ...
        users_list: 'LAST 50 OF USERS SEARCH',
        ...
        store_h_desc: "Get a look at the ongoing count of Steam's players, Browse individual game info, or see the current top most played games",
        s_online: 'ONLINE',
        ...
        footer_p: 'graduation college project, <a target="_top" href="./students" rel="noopener noreferrer">more info</a>',
    },
    ar: {
        sign_in: 'تسجيل',
        header_p_1: 'Steam Games Grabber',
        header_p_2: 'ابحث عن أي قائمة ألعاب من أي ملف تعريف في منصة steam بسهوله عن طريق وضع steamID في البحث, وبعد تسجيلك للدخول يمكنك رؤية قائمة أصدقائك بالألعاب الخاصة بهم',
        ...
        directions_4: 'إذا لم تقم مطلقًا بتعيين عنوان URL مخصص لـ Steam لحسابك، فسيتم عرض معرف 64 بت في عنوان URL ضمن مربع عنوان URL المخصص بالتنسيق التالي 76561198 #########',
        directions_5: 'إذا قمت بتعيين عنوان URL مخصص لحسابك ، فيمكنك حذف النص في مربع عنوان URL المخصص لرؤية معرف 64 بت لحسابك.',
        example: 'مثـال: 76561198866821009',
        history: 'سجل البث',
        save_as_1: 'حفظ ك CSV',
        ...
        users_list: 'بحث آخر 50 مستخدمًا',
        ...
        store_h_desc: 'ألقِ نظرة سريعه على عدد اللاعبين في منصة Steam أو شاهد أكثر الالعاب ترويجاً',
        ...
        footer_p: 'مشروع تخرج كلية التقنية, <a target="_top" href="./students">المزيد من التفاصيل</a>',
    }
}